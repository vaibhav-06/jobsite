...
<body>
  ...
  <strong>Success!</strong> You have posted the job.
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    }
    include 'temp/_navbar1.php';
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="temp/jobpost.php">Posted jobs</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="temp/job.php">Create jobs</a>
          </li>
        </ul>';
