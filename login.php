...
$loginpass = md5($_POST["loginpass"]);
 ...
 // $sql = "SELECT * from users where username='$username' AND password='$password'";
  $sql = "SELECT * from `jobseeker` where email='$loginemail'";
  ...
  if($num == 1){
    ...
    $sql1 = "SELECT * from `jsprofile` where epid='$id'";
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    < <h1 class="text-center">Employee</h1>
        ...
        <div class="fcontainer">
            <form action="/jsite/login.php" method="post">
        ...
        <p>Not registered?<a class="aj" href="/jsite/register.php"> Click here to register</a></p>
